 ...
 */
class getTerrainRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TerrainRepository' shared autowired service.
     *
     * @return \App\Repository\TerrainRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TerrainRepository.php';

        return $container->privates['App\\Repository\\TerrainRepository'] = new \App\Repository\TerrainRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
