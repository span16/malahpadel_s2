...
class getEvenementControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\EvenementController'] = $instance = new \App\Controller\EvenementController(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->privates['App\\Repository\\LikeDislikeRepository'] ?? $container->load('getLikeDislikeRepositoryService')));
