 ...
 */
class getCompagneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompagneRepository' shared autowired service.
     *
     * @return \App\Repository\CompagneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompagneRepository.php';

        return $container->privates['App\\Repository\\CompagneRepository'] = new \App\Repository\CompagneRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
