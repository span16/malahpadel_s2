 ...
 */
class getLoginhistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LoginhistoryRepository' shared autowired service.
     *
     * @return \App\Repository\LoginhistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LoginhistoryRepository.php';

        return $container->privates['App\\Repository\\LoginhistoryRepository'] = new \App\Repository\LoginhistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
